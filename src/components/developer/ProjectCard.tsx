...
export default function ProjectCard({ project }: ProjectCardProps) {
  return (
    <article className="from-misty-purple/50 to-deep-canyon/60 hover:shadow-vibrant-teal/30 rounded-md bg-linear-to-br p-4 shadow-2xl transition-all duration-500 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col gap-2 md:gap-4 font-mono font-light">
        ...
        <div className="grid grid-cols-2 gap-1 md:gap-2 px-4 md:grid-cols-3 lg:gap-3">

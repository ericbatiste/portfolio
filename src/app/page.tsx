  ...
  return (
    <div ref={containerRef} className="snap-y">
      ...
      <section className="relative z-40 flex h-screen w-full snap-center items-center justify-center">
        <h1 className="text-howdy-amber font-heading text-9xl font-extrabold tracking-wide drop-shadow-lg">
          Howdy
        </h1>
      </section>
      ...
      >
        <div className="relative h-[70%] w-[80%]">
          ...
          <motion.div
            ...
            viewport={{ once: true, amount: 0.2 }}
            className="border-rich-terracotta absolute right-6 bottom-6 h-[92%] w-[82%] border-r-2 border-b-2"
          >
            <Link
              href="/music"

  ...
  return (
    <div ref={containerRef} className="snap-y">
      ...
      <section className="relative z-40 flex h-screen w-full snap-center items-center justify-center">
        <h1 className="text-howdy-amber font-heading text-9xl font-bold drop-shadow-lg">
          Howdy
        </h1>
      </section>
      ...
      >
        ...
        <motion.div
          ...
          className="text-lighter z-40 text-center text-4xl leading-18"
        >
          <p className="text-deep-canyon drop-shadow-md drop-shadow-stone-700">
          ...
          <Link
            href={'/contact'}
            scroll={false}
            className="text-howdy-amber bg-dark hover:text-dark mt-10 inline-block rounded-full px-8 py-4 text-2xl font-semibold shadow-lg ring-2 transition-colors hover:bg-amber-400"
          >
            Reach out!
          </Link>
        </motion.div>
      ...
      <section
        ref={containerRef}
        className="pointer-events-none relative z-10 h-screen w-full snap-center"
      >
        <motion.div
          ...
          className="border-sky-blue absolute bottom-[8vw] left-[12vw] h-[68%] w-[65vw] border-t-2 border-l-2"
        >
          <Link
            href="/developer"
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          className="border-rich-terracotta absolute right-[12vw] bottom-[10vw] h-[68%] w-[65vw] border-r-2 border-b-2"
        >
          <Link
            href="/music"
            className="pointer-events-auto relative flex h-full w-full items-end justify-end overflow-hidden bg-[rgba(0,0,0,0.2)]"
            style={{
              clipPath: 'polygon(100% 0, 100% 100%, 0 100%)',
            }}
          >
            <div className="guitar-img absolute inset-0" />
